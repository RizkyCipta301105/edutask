...
urlpatterns = [
    ...
    path('start-chat/', views.CreateChatByCodeView.as_view(), name='inbox-start-chat'),
    ...
    path('threads/<uuid:thread_id>/clear/', views.ClearChatView.as_view(), name='inbox-clear-chat'),
]
