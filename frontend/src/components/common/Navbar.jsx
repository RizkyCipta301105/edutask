...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <header className="sticky top-0 z-30 flex min-h-20 items-center gap-3 border-b border-zinc-200 bg-white px-4 lg:fixed lg:left-64 lg:right-0 lg:px-8">
        <button onClick={() => navigate('/dashboard')}
          className="lg:hidden flex h-10 w-10 items-center justify-center rounded-md bg-zinc-900 text-white font-bold">
          E
        </button>
        ...
        <button onClick={() => navigate('/profile')}
          className="flex h-11 items-center gap-2 rounded-md bg-zinc-200 px-3 text-sm font-semibold text-zinc-800 transition-colors hover:bg-zinc-300">
          <User size={18} />
